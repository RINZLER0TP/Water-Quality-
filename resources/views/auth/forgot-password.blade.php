...
<head>
    ...
    <title>Water Quality — Recuperar contraseña</title>
...
<div class="card">
    <div class="left">
        ...
        <div class="hero">
            ...
            <p class="hero-p">Introduce tu correo y te enviaremos un enlace seguro para restablecer la contraseña.</p>
        </div>
    ...
    <div class="right">
        <div class="fhead">
            <p class="ftag">Recuperar acceso</p>
            <h1 class="ftitle">Restablecer contraseña</h1>
            <p class="fsub">Te enviaremos un enlace para que elijas una nueva contraseña.</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}" novalidate>
            ...
            <div class="btn-wrap" style="margin-top: 1.5rem;">
        ...
        <div class="sep">o</div>
        <p class="reg"><a href="{{ route('login') }}">Volver al inicio de sesión</a></p>
...
(function(){
    ...
    const line1 = 'Recupera tu acceso';
    const line2 = 'sin perder el flujo.';
    let phase = 0, ci = 0;
